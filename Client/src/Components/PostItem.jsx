...
function PostItem({
  ...
  const ActionButtons = ({ isMyPost, onEditPost, onDeletePost, post, onToggleExpand, isExpanded = false, stopPropagation = false }) => (
    <>
      {isMyPost && onEditPost && (
        <button
      ...
      {onToggleExpand && (
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path d={isExpanded ? "M7.41 15.41L12 10.83l4.59 4.58L18 14l-6-6-6 6z" : "M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"} />
          </svg>
        </button>
      )}
    </>
