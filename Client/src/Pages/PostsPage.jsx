...
import { getPostsByUserId, createPost, updatePost, deletePost } from '../Services/postService';
...
function PostsPage() {
  ...
  const handleSaveEdit = async (e) => {
    ...
    try {
      ...
      if (expandedPost?.id === editingPost.id) setExpandedPost(updatedPost);
  ...
  const handleAddPost = async (e) => {
    ...
    try {
      const createdPost = await createPost({ ...newPost, userId: user.id });
